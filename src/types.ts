...
export interface MoltbotEnv {
  ...
  POE_API_KEY?: string; // Poe API key (forwarded to container for provider config)
  ...
  SANDBOX_SLEEP_AFTER?: string; // How long before sandbox sleeps: '1h' (default), or duration like '10m', 'never'
